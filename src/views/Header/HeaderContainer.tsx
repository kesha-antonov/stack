...
export default class HeaderContainer extends React.PureComponent<Props> {
  render() {
    let {
      mode,
      scenes,
    ...
    return (
      <View pointerEvents="box-none" style={style}>
        {/* We would get a lot of mileage out of ensuring that we don't
        re-render headers unnecessarily, eg: render old header when we are
